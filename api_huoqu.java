...
public class api_huoqu {
	public static char read_char ='0';
    ...
    */
            ...
            while(ch!='}')
            {
            	...
            	if(ch=='n')
            	{
            		 if(result.charAt(n+3)=='e')
            		 {
            			 ...
            			 read_char = readString.charAt(0);
            			 //System.out.println("字符是	"+read_char);
            		 }
            	}
            	n++;
            }
    ...
    public static char getRead_char() {
		return read_char;
	}
	...
	public static void setRead_char(char read_char) {
		api_huoqu.read_char = read_char;
	}
